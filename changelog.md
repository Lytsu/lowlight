...
- 本站技术层面上的内容基本搭建完成，不出意外未来很长一段时间都不会进行大的改动，因此今天的版本正式 tag 成 Version 1.0.0。
- 由于「东京 BBTEC」和「香港 CMI」两个节点硬盘空间日趋爆满，同时也为了方便的让更多人玩到其他游戏，进行以下节点调整：
  - Phigros 的**所有版本**将从「东京 BBTEC」和「香港 CMI」节点移除，仅保留其他节点下载；
  - 其余经典音游（TAKUMI³）的**最新版本**将增加「东京 BBTEC」和「香港 CMI」节点；
  - 现有的社交卡牌类音游（BanG Dream / LLSIF / PRSK / D4DJ）将增加「东京 BBTEC」和「香港 CMI」节点；
  - 现有的社区驱动类音游（Malody / osu!Lazer / Sonolus）将增加「东京 BBTEC」和「香港 CMI」版本；
  - 桌面端方面，Malody 将会新增「东京 BBTEC」和「香港 CMI」节点。
